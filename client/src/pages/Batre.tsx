    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-950 text-white py-16">
        <div className="container">
          ...
          <h1 className="font-display text-5xl md:text-7xl tracking-wide mb-4">BATRE</h1>
          <p className="text-gray-400 text-lg max-w-xl">Temukan batre VOXA yang sesuai untuk kendaraan Anda</p>
        </div>
      </div>
